...
<script runat="server">
  ...
  function formatUrl(url){
    var today = Platform.Function.FormatDate(Platform.Function.Now(), "yyyyMMdd");
    return today;
  }
  /* =========================================================
  ...
  try {
    ...
    for (var i = 0; i < productList.length; i++) {
      ...
      if (row) {
        ...
        var pdp = formatUrl("a");//row["url_pdp"] ? formatUrl(row["url_pdp"]) : formatUrl("https://www.cruzverde.cl/");
